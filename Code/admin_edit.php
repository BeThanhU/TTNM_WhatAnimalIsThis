...
<body>
    ...
    <?php
        include_once 'php/connection.php';
        $edit=$_GET['edit'];
        $sql = "SELECT * FROM animals WHERE TenKhoaHoc = '".$edit."'";
            ...
            while($row = $result->fetch_assoc()){
                echo "
                    ...
                    <section class='form login'>
                        <header>Chỉnh sửa thông tin động vật</header>
                    <form action='php/admin_edit.php' method='POST' enctype='multipart/form-data' autocomplete='off' id='update_form'>
                        ...
                        <div class='field input'>
                            ...
                            <input type='text' name='tentiengviet' value='".$row['TenTiengViet']."'>
                        </div>
                        <div class='field input'>
                        ...
                        <div class='field'>
                            ...
                            $sql2 = "SELECT * FROM animals_img WHERE TenKhoaHoc = '".$edit."'";
                        ...
                        <label>Nhập ảnh mới</label>
                        <input type='file' name='image[]' id='file-input' accept='image/x-png,image/gif,image/jpeg,image/jpg' multiple required>
                        </div>
                        <div id='preview'></div>
                        <div class='field button'>
                            <input class='submit' type='submit' name='submit' value='Xác nhận'>
                        </div>
                        <div class='field button2'>
                            <input class='submit' type='submit' name='cancel' value='Quay lại'>
                        </div>    
