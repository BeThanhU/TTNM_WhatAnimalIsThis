...
<body>
    ...
    <div class="content">
        ...
        <div class="button">
            ...
            <div class="manager">
                <a href="manager_page.php">Quản lý CSDL</a>
            </div>
            <div class="logout">
        ...
        <div class="table_update">
          <?php
            if ($_SESSION['role'] === 'user') {
              echo "
              <h3>Danh sách yêu cầu cập nhật</h3>
              <table>
              <tr>
                <th>Ngày gửi</th>
              ...
              <table>
              <tr>
                <th class='collum1'>Ngày gửi</th>
                <th class='collum2'>Người gửi</th>
                <th class='collum3'>Yêu cầu</th>
                <th class='collum4'>Chức năng</th>
              </tr>";
                  ...
                  <tr>
                    ...
                    while($row = mysqli_fetch_assoc($sql3)){ 
                        echo "<tr>                      
                          ...
                          <td class='status'><a href='admin_update.php?update=".$row['TenKhoaHoc']."'>Xem chi tiết</a></td>
                        </tr>";
                      }
                    }
                    ...
                    $sql3 = mysqli_query($conn, "SELECT * FROM animals_update INNER JOIN users 
                                                  ON animals_update.NguoiYeuCau = users.user_id 
                                                  WHERE animals_update.TrangThai = 'Đã duyệt' 
                                                  ORDER BY NgayCapNhat DESC");
                    if(mysqli_num_rows($sql3) == 0){
                        echo "
                        <tr>
                          ...
                          $sql3 = mysqli_query($conn, "SELECT * FROM animals_update INNER JOIN users 
                                                        ON animals_update.NguoiYeuCau = users.user_id 
                                                        WHERE animals_update.TrangThai = 'Từ chối' 
                                                        ORDER BY NgayCapNhat DESC");
                          if(mysqli_num_rows($sql3) == 0){
                              echo "
                              <tr>
